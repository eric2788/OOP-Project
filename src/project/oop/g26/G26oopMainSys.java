    ...
    public static void main(String[] args) {
        ...
        G26Course java = G26Course.Builder.name("Java")
                ...
                .showAboutMe(component -> {
                    ...
                    JOptionPane.showMessageDialog(null, Intro, "About Me: Eric", JOptionPane.INFORMATION_MESSAGE, mem);
                })
        ...
        G26Course C = G26Course.Builder.name("C")
                ...
                .showAboutMe(component -> {
                    ...
                    JOptionPane.showMessageDialog(null, Intro, "About Me: Keith", JOptionPane.INFORMATION_MESSAGE, mem);
                })
                .create(createFunction).build();
        ...
        G26Course Cpp = G26Course.Builder.name("C++")
                ...
                .showAboutMe(component -> {
                    ...
                    JOptionPane.showMessageDialog(null, Intro, "About Me: Libby", JOptionPane.INFORMATION_MESSAGE, mem);
                })
                .create(createFunction).build();
        ...
        G26Course py = G26Course.Builder.name("Python")
                ...
                .showAboutMe(component -> {
                    ...
                    JOptionPane.showMessageDialog(null, Intro, "About Me:  Matthew", JOptionPane.INFORMATION_MESSAGE, mem);
                })
                .create(createFunction).build();
